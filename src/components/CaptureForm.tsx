      ...
      <div className="max-w-[680px] mx-auto text-center relative z-10">
        ...
        {!submitted ? (
          ...
          <motion.div
            ...
            className="bg-[#00c78b] border border-white/20 rounded-2xl p-10 text-center"
          >
             ...
             <h3 className="font-display text-[22px] font-bold text-white mb-3">Early Access Request Sent!</h3>
